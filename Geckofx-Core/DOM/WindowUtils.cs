...
namespace Gecko.DOM
{
    ...
    /// </summary>		
        ...
        /// privileges.
        /// </summary>		
        public void SetDisplayPortForElement(float aXPx, float aYPx, float aWidthPx, float aHeightPx,
            GeckoElement aElement, uint aPriority)
        {
            _windowUtils.Instance.SetDisplayPortForElement(aXPx, aYPx, aWidthPx, aHeightPx,
                (nsIDOMElement) aElement.DomObject, aPriority);
        }
        ...
        /// during dispatch
        /// </summary>		
        public void SendMouseEvent(string aType, float aX, float aY, GeckoMouseButton aButton, int aClickCount,
            int aModifiers, bool aIgnoreRootScrollFrame, float aPressure, ushort aInputSourceArg)
        {
        ...
        /// </summary>		
        public void SendMouseEventToWindow(string aType, float aX, float aY, GeckoMouseButton aButton, int aClickCount,
            int aModifiers, bool aIgnoreRootScrollFrame, float aPressure, ushort aInputSourceArg)
        {
            using (nsAString type = new nsAString(aType))
            {
        ...
        /// privileges.
        /// </summary>		
        public void SendNativeKeyEvent(int aNativeKeyboardLayout, int aNativeKeyCode, int aModifierFlags,
            string aCharacters, string aUnmodifiedCharacters)
        {
            using (
                nsAString characters = new nsAString(aCharacters),
                    unmodifiedCharaters = new nsAString(aUnmodifiedCharacters))
            {
                _windowUtils.Instance.SendNativeKeyEvent(aNativeKeyboardLayout, aNativeKeyCode, aModifierFlags,
        ...
        /// privileges.
        /// </summary>
        public void SendNativeMouseEvent(int aScreenX, int aScreenY, int aNativeMessage, int aModifierFlags,
            GeckoElement aElement)
        {
            _windowUtils.Instance.SendNativeMouseEvent(aScreenX, aScreenY, aNativeMessage, aModifierFlags,
                (nsIDOMElement) aElement.DomObject, null);
        }
        ...
        /// privileges.
        /// </summary>
        public void SendWheelEvent(float aX, float aY, double aDeltaX, double aDeltaY, double aDeltaZ, uint aDeltaMode,
            int aModifiers, int aLineOrPageDeltaX, int aLineOrPageDeltaY, uint aOptions)
        {
            _windowUtils.Instance.SendWheelEvent(aX, aY, aDeltaX, aDeltaY, aDeltaZ, aDeltaMode, aModifiers,
                aLineOrPageDeltaX, aLineOrPageDeltaY, aOptions);
        }
        ...
        /// @param aModifiers modifiers pressed, using constants defined in nsIDOMNSEvent
        /// </summary>		
        public void SendSimpleGestureEvent(string aType, float aX, float aY, uint aDirection, double aDelta,
            int aModifiers)
        {
        ...
        /// @param aFlushLayout flushes layout if true. Otherwise, no flush occurs.
        /// </summary>		
        public GeckoNodeCollection NodesFromRect(float aX, float aY, float aTopSize, float aRightSize, float aBottomSize,
        ...
        /// </summary>		
        public void SendTextEvent(string aCompositionString, int aFirstClauseLength, uint aFirstClauseAttr,
            int aSecondClauseLength, uint aSecondClauseAttr, int aThirdClauseLength, uint aThirdClauseAttr,
            int aCaretStart, int aCaretLength)
        {
            throw new NotImplementedException();
        }
        ...
        /// </summary>		
        public string GetVisitedDependentComputedStyle(GeckoHtmlElement aElement, string aPseudoElement,
        ...
        ///
        /// </summary>		
        public bool GetFileReferences(string aDatabaseName, long aId, ref int aRefCnt, ref int aDBRefCnt,
            ref int aSliceRefCnt)
        {
            throw new NotImplementedException();
        }
