...
namespace Gecko
{
    ...
    public static class nsString
    {
        ...
        private static void GenericSet<TString>(Action<TString, TString, TString> setter, string value1, string value2,
            string value3)
            where TString : IString, IDisposable, new()
        {
        ...
        private static void GenericSet<T1, T2, TString>(Action<T1, T2, TString> func, T1 value1, T2 value2,
            string stringValue)
            where TString : IString, IDisposable, new()
        {
            using (var native = new TString())
        ...
        private static void GenericSet<T1, TString, T2>(Action<T1, TString, T2> func, T1 value1, string stringValue,
            T2 value2)
            where TString : IString, IDisposable, new()
        {
            using (var native = new TString())
        ...
        private static T GenericPass<T, TString>(Func<TString, TString, TString, T> func, string value1, string value2,
            string value3)
            where TString : IString, IDisposable, new()
        {
            T ret;
        ...
        public static T Pass<T>(Func<nsAString, nsAString, nsAString, T> func, string value1, string value2,
            string value3)
        {
...
#pragma warning restore 169
        ...
        : IString
    {
        ...
        [DllImport("xul", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        protected static extern void NS_CStringSetIsVoid(nsAUTF8StringBase str,
            [MarshalAs(UnmanagedType.Bool)] bool isVoid);
...
#pragma warning restore 169
        ...
        : IString, IDisposable
    {
        ...
        [DllImport("xul", CallingConvention = CallingConvention.Cdecl)]
        protected static extern int NS_StringGetData(IntPtr str, out IntPtr data,
            [MarshalAs(UnmanagedType.U1)] out bool nullTerm);
        ...
        [DllImport("xul", EntryPoint = "NS_StringSetData", CharSet = CharSet.Unicode,
