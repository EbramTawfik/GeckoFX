...
namespace Gecko
{
	...
	public interface nsISliderListener
	{
		...
		void ValueChanged([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase which, int newValue, [MarshalAs(UnmanagedType.U1)] bool userChanged);
