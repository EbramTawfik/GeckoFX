...
namespace Gecko
{
	...
	[Guid("a7ddd388-5fdf-4af8-b3ee-7e1baa636b66")]
	public interface nsIDOMTimeEvent : nsIDOMEvent
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitTimeEvent([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase typeArg, [MarshalAs(UnmanagedType.Interface)] nsIDOMWindow viewArg, int detailArg);
	}
}
