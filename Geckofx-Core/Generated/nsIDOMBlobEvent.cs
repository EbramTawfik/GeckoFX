...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMBlobEvent.idl
// 
...
namespace Gecko
{
	...
	[Guid("84293ee0-68f5-11e2-9906-cf63ba8c6e43")]
	public interface nsIDOMBlobEvent : nsIDOMEvent
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMBlob GetDataAttribute();
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitBlobEvent([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aType, [MarshalAs(UnmanagedType.U1)] bool aCanBubble, [MarshalAs(UnmanagedType.U1)] bool aCancelable, [MarshalAs(UnmanagedType.Interface)] nsIDOMBlob aData);
	}
}
