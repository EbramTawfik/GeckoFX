...
namespace Gecko
{
	...
	public interface nsISimpleUnicharStreamFactory
	{
		...
		nsIUnicharInputStream CreateInstanceFromString([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase aString);
