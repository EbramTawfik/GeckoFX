...
// 
// <remarks>
// Generated by IDLImporter from file nsITextInputProcessor.idl
// 
...
namespace Gecko
{
	...
	public interface nsITextInputProcessor
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetPendingCompositionString([MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Gecko.CustomMarshalers.AStringMarshaler")] nsAStringBase aString);
		...
		[return: MarshalAs(UnmanagedType.U1)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		bool GetModifierState([MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Gecko.CustomMarshalers.AStringMarshaler")] nsAStringBase aModifierKey);
	...
	/// <summary>nsITextInputProcessorConsts </summary>
	public class nsITextInputProcessorConsts
	{
		
		// <summary>
        // yet.
        // </summary>
		public const ulong ATTR_RAW_CLAUSE = 0x02;
		
		// <summary>
        // but is selected for converting to the other string.
        // </summary>
		public const ulong ATTR_SELECTED_RAW_CLAUSE = 0x03;
		
		// <summary>
        // is not selected.  This does NOT mean that this clause isn't modifiable.
        // </summary>
		public const ulong ATTR_CONVERTED_CLAUSE = 0x04;
		
		// <summary>
        // is selected.  In other words, the clause is being converted.
        // </summary>
		public const ulong ATTR_SELECTED_CLAUSE = 0x05;
		
		// <summary>
        // won't be fired.
        // </summary>
		public const ulong KEY_DEFAULT_PREVENTED = 0x00000001;
		
		// <summary>
        // such key events input the key values as text.
        // </summary>
		public const ulong KEY_NON_PRINTABLE_KEY = 0x00000002;
		
		// <summary>
        // registered key name, it's treated as inputting text value.
        // </summary>
		public const ulong KEY_FORCE_PRINTABLE_KEY = 0x00000004;
		
		// <summary>
        // NOTE: This is not recommended to use except for tests.
        // </summary>
		public const ulong KEY_KEEP_KEY_LOCATION_STANDARD = 0x00000008;
		
		// <summary>
        // non-zero value, this flag causes throwing an exception.
        // </summary>
		public const ulong KEY_KEEP_KEYCODE_ZERO = 0x00000010;
		
		// <summary>
        // or emulating legacy API behavior.
        // </summary>
		public const ulong KEY_DONT_DISPATCH_MODIFIER_KEY_EVENT = 0x00000020;
		
		// <summary>
        // the keydown() method.
        // </summary>
		public const ulong KEYEVENT_NOT_CONSUMED = 0x00000000;
		
		// 
		public const ulong KEYDOWN_IS_CONSUMED = 0x00000001;
		
		// 
		public const ulong KEYPRESS_IS_CONSUMED = 0x00000002;
	}
}
