...
// 
// <remarks>
// Generated by IDLImporter from file nsINetworkSeer.idl
// 
...
namespace Gecko
{
	...
	[Guid("25e323b6-99e0-4274-b5b3-1a9eb56e28ac")]
	public interface nsINetworkSeer
	{
		...
		void Predict([MarshalAs(UnmanagedType.Interface)] nsIURI targetURI, [MarshalAs(UnmanagedType.Interface)] nsIURI sourceURI, SeerPredictReason reason, [MarshalAs(UnmanagedType.Interface)] nsILoadContext loadContext, [MarshalAs(UnmanagedType.Interface)] nsINetworkSeerVerifier verifier);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void Learn([MarshalAs(UnmanagedType.Interface)] nsIURI targetURI, [MarshalAs(UnmanagedType.Interface)] nsIURI sourceURI, SeerLearnReason reason, [MarshalAs(UnmanagedType.Interface)] nsILoadContext loadContext);
	...
	/// <summary>nsINetworkSeerConsts </summary>
	public class nsINetworkSeerConsts
	{
