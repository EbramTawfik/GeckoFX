...
namespace Gecko
{
	...
	public interface nsIDOMHTMLCanvasElement
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void ToDataURL([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase type, Gecko.JsVal @params, System.IntPtr jsContext, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase retval);
