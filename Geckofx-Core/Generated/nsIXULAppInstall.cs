...
namespace Gecko
{
	...
	public interface nsIXULAppInstall
	{
		...
		void InstallApplication([MarshalAs(UnmanagedType.Interface)] nsIFile aAppFile, [MarshalAs(UnmanagedType.Interface)] nsIFile aDirectory, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aLeafName);
	}
}
