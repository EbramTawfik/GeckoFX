...
namespace Gecko
{
	...
	public interface nsIPhonetic
	{
		...
		void GetPhoneticAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase aPhonetic);
	}
}
