...
namespace Gecko
{
	...
	public interface amIWebInstaller
	{
		...
		bool IsInstallEnabled([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase aMimetype, [MarshalAs(UnmanagedType.Interface)] nsIURI aReferer);
