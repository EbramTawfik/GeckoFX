...
namespace Gecko
{
	...
	public interface jsdIStackFrame : jsdIEphemeral
	{
		...
		[return: MarshalAs(UnmanagedType.U1)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		bool Eval([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase bytes, [MarshalAs(UnmanagedType.LPStruct)] nsAUTF8StringBase fileName, uint line, ref jsdIValue result);
	}
	...
	public interface jsdIScript : jsdIEphemeral
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetFunctionSourceAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Gecko.CustomMarshalers.AStringMarshaler))] nsAStringBase aFunctionSource);
