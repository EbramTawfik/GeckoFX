...
namespace Gecko
{
    public static class CategoryManager
    {
        ...
        public static string AddCategoryEntry(string aCategory, string aEntry, string aValue, bool aPersist,
            bool aReplace)
        {
        ...
        public static IEnumerable<string> Categories
        {
            ...
            {
                return
                    new GeckoEnumerableCollection<string, nsISupportsCString>(
                        () => _categoryManager.Instance.EnumerateCategories(),
