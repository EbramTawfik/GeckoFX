...
namespace Gecko
{
    partial class GeckoWebBrowser
    {
        ...
        {
            add { Events.AddHandler(RedirectingEvent, value); }
            remove { Events.RemoveHandler(RedirectingEvent, value); }
        }
        ...
        {
            add { Events.AddHandler(RequestProgressChangedEvent, value); }
            remove { Events.RemoveHandler(RequestProgressChangedEvent, value); }
        }
        ...
        {
            add { Events.AddHandler(DOMContentLoadedEvent, value); }
            remove { Events.RemoveHandler(DOMContentLoadedEvent, value); }
        }
        ...
        {
            add { Events.AddHandler(ReadyStateChangeEvent, value); }
            remove { Events.RemoveHandler(ReadyStateChangeEvent, value); }
        }
        ...
        : EventArgs
    {
        ...
        {
            get { return _reqWrapper ?? (_reqWrapper = new GeckoResponse(_request)); }
        }
    }
        ...
        : EventArgs
    {
        ...
        internal GeckoNavigatedEventArgs(Uri value, nsIRequest response, GeckoWindow domWind, bool _sameDocument,
            bool _errorPage)
        {
            Uri = value;
            _response = response;
        ...
        : EventArgs
    {
        ...
        public GeckoContextMenuEventArgs(Point location, ContextMenu contextMenu, string associatedLink,
            Uri backgroundImageSrc, Uri imageSrc, GeckoNode targetNode)
        {
            Location = location;
        ...
        : CancelEventArgs
    {
        ...
        public GeckoObserveHttpModifyRequestEventArgs(Uri uri, Uri refVal, String reqMethod, Byte[] reqBody,
            List<KeyValuePair<string, string>> reqHeaders, HttpChannel httpChan, bool? bodyContainsHeaders)
            : base(false)
        {
            Uri = uri;
            Referrer = refVal;
