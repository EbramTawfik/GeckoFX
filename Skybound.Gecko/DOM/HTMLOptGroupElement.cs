...
{
	[Guid("a6cf9091-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoOptGroupElement : GeckoElement
	{
		nsIDOMHTMLOptGroupElement DOMHTMLElement;
