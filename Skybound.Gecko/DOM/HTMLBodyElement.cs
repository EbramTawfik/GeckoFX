...
{
	[Guid("a6cf908e-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoBodyElement : GeckoElement
	{
		...
		public string ALink {
			get { return nsString.Get(DOMHTMLElement.GetALink); }
			set { DOMHTMLElement.SetALink(new nsAString(value)); }
		}

		public string Background {
			get { return nsString.Get(DOMHTMLElement.GetBackground); }
			set { DOMHTMLElement.SetBackground(new nsAString(value)); }
		}
		...
		public string Link {
			get { return nsString.Get(DOMHTMLElement.GetLink); }
			set { DOMHTMLElement.SetLink(new nsAString(value)); }
		}
		...
		public string VLink {
			get { return nsString.Get(DOMHTMLElement.GetVLink); }
			set { DOMHTMLElement.SetVLink(new nsAString(value)); }
		}
