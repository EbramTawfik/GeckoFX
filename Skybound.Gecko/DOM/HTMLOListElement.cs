...
{
	[Guid("a6cf909a-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoOListElement : GeckoElement
	{
		...
		public bool Compact {
			get { return DOMHTMLElement.GetCompact(); }
			set { DOMHTMLElement.SetCompact(value); }
		}

		public int Start {
			get { return DOMHTMLElement.GetStart(); }
			set { DOMHTMLElement.SetStart(value); }
		}
