...
{
	[Guid("a6cf90af-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoMapElement : GeckoElement
	{
		...
		public GeckoHtmlElementCollection Areas {
			get { return new GeckoHtmlElementCollection(DOMHTMLElement.GetAreas()); }
		}
