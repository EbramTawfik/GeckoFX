...
{
	[Guid("a6cf908a-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLMetaElement : nsIDOMHTMLElement
	{
        ...
        #endregion
		void GetContent(nsAString aContent);
		void SetContent(nsAString aContent);

		void GetHttpEquiv(nsAString aHttpEquiv);
		void SetHttpEquiv(nsAString aHttpEquiv);

		void GetName(nsAString aName);
		void SetName(nsAString aName);

		void GetScheme(nsAString aScheme);
		void SetScheme(nsAString aScheme);
	...
	public class GeckoMetaElement : GeckoElement
	{
		...
		public string Content {
			get { return nsString.Get(DOMHTMLElement.GetContent); }
			set { DOMHTMLElement.SetContent(new nsAString(value)); }
		}

		public string HttpEquiv {
			get { return nsString.Get(DOMHTMLElement.GetHttpEquiv); }
			set { DOMHTMLElement.SetHttpEquiv(new nsAString(value)); }
		}
		...
		public string Scheme {
			get { return nsString.Get(DOMHTMLElement.GetScheme); }
			set { DOMHTMLElement.SetScheme(new nsAString(value)); }
		}
