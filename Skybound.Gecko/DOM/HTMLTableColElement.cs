...
{
	[Guid("a6cf90b4-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoTableColElement : GeckoElement
	{
		...
		public int Span {
			get { return DOMHTMLElement.GetSpan(); }
			set { DOMHTMLElement.SetSpan(value); }
		}
