...
{
	[Guid("a6cf9086-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLHtmlElement : nsIDOMHTMLElement
	{
		...
		void SetVersion(nsAString aVersion);
	...
	public class GeckoHtmlElement : GeckoElement
	{
		...
		public string Version {
			get { return nsString.Get(DOMHTMLElement.GetVersion); }
			set { DOMHTMLElement.SetVersion(new nsAString(value)); }
		}
