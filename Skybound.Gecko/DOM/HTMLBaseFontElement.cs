...
{
	[Guid("a6cf90a6-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLBaseFontElement : nsIDOMHTMLElement
	{
        ...
        #endregion
		void GetColor(nsAString aColor);
		void SetColor(nsAString aColor);

		void GetFace(nsAString aFace);
		void SetFace(nsAString aFace);

		int GetSize();
		void SetSize(int aSize);

	}
	public class GeckoBaseFontElement : GeckoElement
	{
		nsIDOMHTMLBaseFontElement DOMHTMLElement;
		internal GeckoBaseFontElement(nsIDOMHTMLBaseFontElement element) : base(element)
		{
			this.DOMHTMLElement = element;
		}
		public GeckoBaseFontElement(object element) : base(element as nsIDOMHTMLElement)
		{
			this.DOMHTMLElement = element as nsIDOMHTMLBaseFontElement;
		}
		public string Color {
			get { return nsString.Get(DOMHTMLElement.GetColor); }
			set { DOMHTMLElement.SetColor(new nsAString(value)); }
		}

		public string Face {
			get { return nsString.Get(DOMHTMLElement.GetFace); }
			set { DOMHTMLElement.SetFace(new nsAString(value)); }
		}
