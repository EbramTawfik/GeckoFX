...
{
	[Guid("a6cf90a5-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLBRElement : nsIDOMHTMLElement
	{
        ...
        #endregion
		void GetClear(nsAString aClear);
		void SetClear(nsAString aClear);
	...
	public class GeckoBRElement : GeckoElement
	{
		...
		public string Clear {
			get { return nsString.Get(DOMHTMLElement.GetClear); }
			set { DOMHTMLElement.SetClear(new nsAString(value)); }
		}
