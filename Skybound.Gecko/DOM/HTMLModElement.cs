...
{
	[Guid("a6cf90a9-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLModElement : nsIDOMHTMLElement
	{
		...
		void SetDateTime(nsAString aDateTime);
	...
	public class GeckoModElement : GeckoElement
	{
		...
		public string DateTime {
			get { return nsString.Get(DOMHTMLElement.GetDateTime); }
			set { DOMHTMLElement.SetDateTime(new nsAString(value)); }
		}
