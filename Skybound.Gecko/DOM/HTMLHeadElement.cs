...
{
	[Guid("a6cf9087-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	interface nsIDOMHTMLHeadElement : nsIDOMHTMLElement
	{
        ...
        #endregion
		void GetProfile(nsAString aProfile);
		void SetProfile(nsAString aProfile);
	...
	public class GeckoHeadElement : GeckoElement
	{
		...
		public string Profile {
			get { return nsString.Get(DOMHTMLElement.GetProfile); }
			set { DOMHTMLElement.SetProfile(new nsAString(value)); }
		}
