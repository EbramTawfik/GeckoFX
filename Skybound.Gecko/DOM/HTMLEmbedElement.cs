...
{
	[Guid("123f90ab-15b3-11d2-456e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoEmbedElement : GeckoElement
	{
		nsIDOMHTMLEmbedElement DOMHTMLElement;
