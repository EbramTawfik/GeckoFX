...
{
	[Guid("a6cf909e-15b3-11d2-932e-00805f8add32"), ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public class GeckoLIElement : GeckoElement
	{
		...
		public int Value {
			get { return DOMHTMLElement.GetValue(); }
			set { DOMHTMLElement.SetValue(value); }
		}
