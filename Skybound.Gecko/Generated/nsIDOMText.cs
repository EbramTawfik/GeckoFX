...
namespace Skybound.Gecko
{
	...
	public interface nsIDOMText : nsIDOMCharacterData
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new nsAString SubstringData(System.UInt32  offset, System.UInt32  count);
		...
		/// <param name='arg'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void InsertData(System.UInt32  offset, [MarshalAs(UnmanagedType.LPStruct)] nsAString arg);
		
		/// <summary>Member DeleteData </summary>
		/// <param name='offset'> </param>
		/// <param name='count'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void DeleteData(System.UInt32  offset, System.UInt32  count);
		...
		/// <param name='arg'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void ReplaceData(System.UInt32  offset, System.UInt32  count, [MarshalAs(UnmanagedType.LPStruct)] nsAString arg);
		
		/// <summary>Member SplitText </summary>
		/// <param name='offset'> </param>
		/// <returns>A nsIDOMText</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMText SplitText(System.UInt32  offset);
	}
}
