...
namespace Gecko
{
	...
	[Guid("1b38c0a1-e532-41f1-9ec8-c76236d42cb7")]
	public interface nsIDOMHTMLMediaElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void CanPlayType([MarshalAs(UnmanagedType.LPStruct)] nsAString type, [MarshalAs(UnmanagedType.LPStruct)] nsAString retval);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetAutoplayAttribute([MarshalAs(UnmanagedType.Bool)] bool aAutoplay);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetControlsAttribute([MarshalAs(UnmanagedType.Bool)] bool aControls);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMutedAttribute([MarshalAs(UnmanagedType.Bool)] bool aMuted);
