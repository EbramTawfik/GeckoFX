...
namespace Gecko
{
	...
	public interface nsIRwsService
	{
		...
		uint IconFromExtension([MarshalAs(UnmanagedType.LPStr)] string aExt, [MarshalAs(UnmanagedType.U1)] bool aNeedMini);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		uint IconFromPath([MarshalAs(UnmanagedType.LPStr)] string aPath, [MarshalAs(UnmanagedType.U1)] bool aAbstract, [MarshalAs(UnmanagedType.U1)] bool aNeedMini);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		uint IconFromHandle(uint aHandle, [MarshalAs(UnmanagedType.U1)] bool aNeedMini);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void HandlerFromExtension([MarshalAs(UnmanagedType.LPStr)] string aExt, ref uint aHandle, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase retval);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void HandlerFromPath([MarshalAs(UnmanagedType.LPStr)] string aPath, ref uint aHandle, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase retval);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void TitleFromHandle(uint aHandle, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase retval);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void MenuFromPath([MarshalAs(UnmanagedType.LPStr)] string aPath, [MarshalAs(UnmanagedType.U1)] bool aAbstract);
