...
namespace Skybound.Gecko
{
	...
	public interface nsICookiePromptService
	{
		...
		int CookieDialog([MarshalAs(UnmanagedType.Interface)] nsIDOMWindow parent, [MarshalAs(UnmanagedType.Interface)] nsICookie cookie, [MarshalAs(UnmanagedType.LPStruct)] nsAString hostname, int cookiesFromHost, [MarshalAs(UnmanagedType.Bool)] bool changingCookie, [MarshalAs(UnmanagedType.Bool)] out bool rememberDecision);
	}
}
