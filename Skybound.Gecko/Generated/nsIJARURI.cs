...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIJARURI </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("b0922a89-f87b-4cb5-8612-305a285fcca7")]
	public interface nsIJARURI : nsIURL
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetFilePathAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFilePath);
		
		/// <summary>Member SetFilePathAttribute </summary>
		/// <param name='aFilePath'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetFilePathAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFilePath);
		
		/// <summary>Member GetParamAttribute </summary>
		/// <param name='aParam'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetParamAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aParam);
		
		/// <summary>Member SetParamAttribute </summary>
		/// <param name='aParam'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetParamAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aParam);
		
		/// <summary>Member GetQueryAttribute </summary>
		/// <param name='aQuery'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetQueryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aQuery);
		
		/// <summary>Member SetQueryAttribute </summary>
		/// <param name='aQuery'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetQueryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aQuery);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetDirectoryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aDirectory);
		
		/// <summary>Member SetDirectoryAttribute </summary>
		/// <param name='aDirectory'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetDirectoryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aDirectory);
		
		/// <summary>Member GetFileNameAttribute </summary>
		/// <param name='aFileName'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetFileNameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileName);
		
		/// <summary>Member SetFileNameAttribute </summary>
		/// <param name='aFileName'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetFileNameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileName);
		
		/// <summary>Member GetFileBaseNameAttribute </summary>
		/// <param name='aFileBaseName'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetFileBaseNameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileBaseName);
		
		/// <summary>Member SetFileBaseNameAttribute </summary>
		/// <param name='aFileBaseName'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetFileBaseNameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileBaseName);
		
		/// <summary>Member GetFileExtensionAttribute </summary>
		/// <param name='aFileExtension'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void GetFileExtensionAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileExtension);
		
		/// <summary>Member SetFileExtensionAttribute </summary>
		/// <param name='aFileExtension'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetFileExtensionAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aFileExtension);
		
		/// <summary>Member GetCommonBaseSpec </summary>
		/// <param name='aURIToCompare'> </param>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new nsAString GetCommonBaseSpec([MarshalAs(UnmanagedType.Interface)] nsIURI  aURIToCompare);
		
		/// <summary>Member GetRelativeSpec </summary>
		/// <param name='aURIToCompare'> </param>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new nsAString GetRelativeSpec([MarshalAs(UnmanagedType.Interface)] nsIURI  aURIToCompare);
		
		/// <summary>Member GetJARFileAttribute </summary>
		/// <returns>A nsIURI </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIURI  GetJARFileAttribute();
		
		/// <summary>Member GetJAREntryAttribute </summary>
		/// <param name='aJAREntry'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetJAREntryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aJAREntry);
		
		/// <summary>Member SetJAREntryAttribute </summary>
		/// <param name='aJAREntry'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetJAREntryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aJAREntry);
		
		/// <summary>Member CloneWithJARFile </summary>
		/// <param name='jarFile'> </param>
		/// <returns>A nsIJARURI</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
