...
namespace Skybound.Gecko
{
	...
	public interface nsIProtocolProxyService
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIProxyInfo NewProxyInfo([MarshalAs(UnmanagedType.LPStruct)] nsACString aType, [MarshalAs(UnmanagedType.LPStruct)] nsAUTF8String aHost, int aPort, uint aFlags, uint aFailoverTimeout, [MarshalAs(UnmanagedType.Interface)] nsIProxyInfo aFailoverProxy);
