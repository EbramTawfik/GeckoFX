...
namespace Gecko
{
	...
	/// <summary>nsIHashChangeEventInit </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("e56881c1-3714-45bb-bca3-1453ea24ee90")]
	public interface nsIHashChangeEventInit : nsIEventInit
	{
		...
		/// <summary>Member SetOldURLAttribute </summary>
		/// <param name='aOldURL'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetOldURLAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aOldURL);
		...
		/// <summary>Member SetNewURLAttribute </summary>
		/// <param name='aNewURL'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetNewURLAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aNewURL);
	}
}
