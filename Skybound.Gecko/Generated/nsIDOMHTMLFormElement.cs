...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLFormElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("0884ce23-e069-499e-a13c-a91c8ae0fc98")]
	public interface nsIDOMHTMLFormElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetAcceptCharsetAttribute </summary>
		/// <param name='aAcceptCharset'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetAcceptCharsetAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aAcceptCharset);
		
		/// <summary>Member SetAcceptCharsetAttribute </summary>
		/// <param name='aAcceptCharset'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetAcceptCharsetAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aAcceptCharset);
		
		/// <summary>Member GetActionAttribute </summary>
		/// <param name='aAction'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetActionAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aAction);
		
		/// <summary>Member SetActionAttribute </summary>
		/// <param name='aAction'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetActionAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aAction);
		...
		/// <summary>Member GetEnctypeAttribute </summary>
		/// <param name='aEnctype'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetEnctypeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aEnctype);
		
		/// <summary>Member SetEnctypeAttribute </summary>
		/// <param name='aEnctype'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetEnctypeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aEnctype);
		...
		/// <summary>Member GetNoValidateAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetNoValidateAttribute();
		
		/// <summary>Member SetNoValidateAttribute </summary>
		/// <param name='aNoValidate'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetNoValidateAttribute(System.Boolean  aNoValidate);
		...
		/// <summary>Member GetElementsAttribute </summary>
