...
namespace Gecko
{
	...
	public interface nsIDOMScrollAreaEvent : nsIDOMUIEvent
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitScrollAreaEvent([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aEventType, [MarshalAs(UnmanagedType.Bool)] bool aCanBubble, [MarshalAs(UnmanagedType.Bool)] bool aCancelable, [MarshalAs(UnmanagedType.Interface)] nsIDOMWindow aView, int aDetail, float x, float y, float width, float height);
	}
}
