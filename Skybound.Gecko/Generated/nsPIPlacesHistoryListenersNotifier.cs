...
namespace Gecko
{
	...
	public interface nsPIPlacesHistoryListenersNotifier
	{
		...
		void NotifyOnPageExpired([MarshalAs(UnmanagedType.Interface)] nsIURI aURI, uint aVisitTime, [MarshalAs(UnmanagedType.U1)] bool aWholeEntry, [MarshalAs(UnmanagedType.LPStruct)] nsACString aGUID, ushort aReason);
	}
}
