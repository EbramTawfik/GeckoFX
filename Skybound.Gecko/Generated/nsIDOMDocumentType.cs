...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMDocumentType </summary>
	[ComImport()]
	...
	public interface nsIDOMDocumentType : nsIDOMNode
	{
		...
		/// <summary>Member GetEntitiesAttribute </summary>
		/// <returns>A nsIDOMNamedNodeMap </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMNamedNodeMap  GetEntitiesAttribute();
		
		/// <summary>Member GetNotationsAttribute </summary>
		/// <returns>A nsIDOMNamedNodeMap </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMNamedNodeMap  GetNotationsAttribute();
		...
		/// <summary>Member GetInternalSubsetAttribute </summary>
		/// <param name='aInternalSubset'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
