...
// 
// File: nsIDOMHTMLObjectElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLObjectElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("9b93aab4-7fe8-4f79-9ad2-0623178a0c46")]
	public interface nsIDOMHTMLObjectElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetArchiveAttribute </summary>
		/// <param name='aArchive'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetArchiveAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aArchive);
		
		/// <summary>Member SetArchiveAttribute </summary>
		/// <param name='aArchive'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		/// <summary>Member GetDeclareAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetDeclareAttribute();
		
		/// <summary>Member SetDeclareAttribute </summary>
		/// <param name='aDeclare'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetDeclareAttribute(System.Boolean  aDeclare);
		...
		/// <summary>Member GetHspaceAttribute </summary>
		/// <returns>A System.Int32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Int32  GetHspaceAttribute();
		
		/// <summary>Member SetHspaceAttribute </summary>
		/// <param name='aHspace'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetHspaceAttribute(System.Int32  aHspace);
		...
		/// <summary>Member GetStandbyAttribute </summary>
		/// <param name='aStandby'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetStandbyAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aStandby);
		
		/// <summary>Member SetStandbyAttribute </summary>
		/// <param name='aStandby'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		/// <summary>Member GetVspaceAttribute </summary>
		/// <returns>A System.Int32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Int32  GetVspaceAttribute();
		
		/// <summary>Member SetVspaceAttribute </summary>
		/// <param name='aVspace'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetVspaceAttribute(System.Int32  aVspace);
		...
		/// <summary>Member GetContentDocumentAttribute </summary>
		/// <returns>A nsIDOMDocument </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
