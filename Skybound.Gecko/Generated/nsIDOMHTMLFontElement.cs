...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLFontElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("a6cf90a7-15b3-11d2-932e-00805f8add32")]
	public interface nsIDOMHTMLFontElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetFaceAttribute </summary>
		/// <param name='aFace'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetFaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aFace);
		
		/// <summary>Member SetFaceAttribute </summary>
		/// <param name='aFace'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aFace);
