...
// 
// File: nsIDOMXULSelectCntrlEl.cs
...
namespace Skybound.Gecko
{
	...
	[Guid("919D9808-8937-4CEC-9390-91225EB8864B")]
	public interface nsIDOMXULSelectControlElement : nsIDOMXULControlElement
	{
		...
		/// <returns>A nsIDOMXULSelectControlItemElement</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMXULSelectControlItemElement AppendItem([MarshalAs(UnmanagedType.LPStruct)] nsAString label, [MarshalAs(UnmanagedType.LPStruct)] nsAString value);
		...
		/// <returns>A nsIDOMXULSelectControlItemElement</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMXULSelectControlItemElement InsertItemAt(System.Int32  index, [MarshalAs(UnmanagedType.LPStruct)] nsAString label, [MarshalAs(UnmanagedType.LPStruct)] nsAString value);
		
		/// <summary>Member RemoveItemAt </summary>
		/// <param name='index'> </param>
		/// <returns>A nsIDOMXULSelectControlItemElement</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMXULSelectControlItemElement RemoveItemAt(System.Int32  index);
		
		/// <summary>Member GetItemCountAttribute </summary>
		/// <returns>A System.UInt32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.UInt32  GetItemCountAttribute();
		...
		/// <returns>A nsIDOMXULSelectControlItemElement</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMXULSelectControlItemElement GetItemAtIndex(System.Int32  index);
	}
}
