...
// 
// File: nsIDOMHTMLImageElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLImageElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("3fc9c313-49b9-4315-b39f-7166cf362e10")]
	public interface nsIDOMHTMLImageElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetIsMapAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetIsMapAttribute();
		
		/// <summary>Member SetIsMapAttribute </summary>
		/// <param name='aIsMap'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetIsMapAttribute(System.Boolean  aIsMap);
		...
		/// <summary>Member GetNaturalWidthAttribute </summary>
		/// <returns>A System.Int32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Int32  GetNaturalWidthAttribute();
		
		/// <summary>Member GetNaturalHeightAttribute </summary>
		/// <returns>A System.Int32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Int32  GetNaturalHeightAttribute();
		
		/// <summary>Member GetCompleteAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetCompleteAttribute();
		...
		/// <summary>Member GetLongDescAttribute </summary>
		/// <param name='aLongDesc'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetLongDescAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aLongDesc);
		
		/// <summary>Member SetLongDescAttribute </summary>
		/// <param name='aLongDesc'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		/// <summary>Member GetLowsrcAttribute </summary>
		/// <param name='aLowsrc'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetLowsrcAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aLowsrc);
		
		/// <summary>Member SetLowsrcAttribute </summary>
		/// <param name='aLowsrc'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
