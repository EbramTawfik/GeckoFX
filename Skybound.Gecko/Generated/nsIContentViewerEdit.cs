...
namespace Gecko
{
	...
	public interface nsIContentViewerEdit
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetContents([MarshalAs(UnmanagedType.LPStr)] string aMimeType, [MarshalAs(UnmanagedType.Bool)] bool aSelectionOnly, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase retval);
