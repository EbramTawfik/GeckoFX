...
namespace Skybound.Gecko
{
	...
	[Guid("df4a19b4-81f1-412e-a971-fcbe7312a9b6")]
	public interface nsIDOMHTMLCommandElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetIconAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aIcon);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetRadiogroupAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aRadiogroup);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetRadiogroupAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aRadiogroup);
	}
}
