...
// 
// File: nsIDOMSVGTextContentElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMSVGTextContentElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("87ad94bc-07c9-412b-b2d8-de245a2e84a5")]
	public interface nsIDOMSVGTextContentElement : nsIDOMSVGElement
	{
		...
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetSubStringLength(System.UInt32  charnum, System.UInt32  nchars);
		
		/// <summary>Member GetStartPositionOfChar </summary>
		/// <param name='charnum'> </param>
		/// <returns>A nsIDOMSVGPoint</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPoint GetStartPositionOfChar(System.UInt32  charnum);
		
		/// <summary>Member GetEndPositionOfChar </summary>
		/// <param name='charnum'> </param>
		/// <returns>A nsIDOMSVGPoint</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPoint GetEndPositionOfChar(System.UInt32  charnum);
		
		/// <summary>Member GetExtentOfChar </summary>
		/// <param name='charnum'> </param>
		/// <returns>A nsIDOMSVGRect</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGRect GetExtentOfChar(System.UInt32  charnum);
		
		/// <summary>Member GetRotationOfChar </summary>
		/// <param name='charnum'> </param>
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetRotationOfChar(System.UInt32  charnum);
		...
		/// <param name='nchars'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SelectSubString(System.UInt32  charnum, System.UInt32  nchars);
	}
}
