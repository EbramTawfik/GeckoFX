...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMDeviceMotionEvent.idl
// 
...
namespace Gecko
{
	...
	/// <summary>nsIDOMDeviceAcceleration </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("2AD6EBC0-35AB-41D0-A755-0CA6A0E21565")]
	public interface nsIDOMDeviceAcceleration
	{
	...
	/// <summary>nsIDOMDeviceRotationRate </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("E76AC929-61FE-4519-9EAC-D496A53CBC9B")]
	public interface nsIDOMDeviceRotationRate
	{
		
		/// <summary>Member GetAlphaAttribute </summary>
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetAlphaAttribute();
		
		/// <summary>Member GetBetaAttribute </summary>
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetBetaAttribute();
		
		/// <summary>Member GetGammaAttribute </summary>
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetGammaAttribute();
	}
	...
	public interface nsIDOMDeviceMotionEvent : nsIDOMEvent
	{
		...
		/// <param name='accelerationIncludingGravity'> </param>
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMDeviceAcceleration GetAccelerationAttribute();
		
		/// <summary>Member GetAccelerationIncludingGravityAttribute </summary>
		/// <returns>A nsIDOMDeviceAcceleration</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMDeviceAcceleration GetAccelerationIncludingGravityAttribute();
		
		/// <summary>Member GetRotationRateAttribute </summary>
		/// <returns>A nsIDOMDeviceRotationRate</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMDeviceRotationRate GetRotationRateAttribute();
		
		/// <summary>Member GetIntervalAttribute </summary>
		/// <returns>A System.Double</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
