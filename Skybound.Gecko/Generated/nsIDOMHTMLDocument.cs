...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLDocument </summary>
	[ComImport()]
	...
	public interface nsIDOMHTMLDocument : nsIDOMDocument
	{
		...
		/// <summary>Member GetImagesAttribute </summary>
		/// <returns>A nsIDOMHTMLCollection </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLCollection  GetImagesAttribute();
		
		/// <summary>Member GetAppletsAttribute </summary>
		/// <returns>A nsIDOMHTMLCollection </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		/// <summary>Member Writeln </summary>
		/// <param name='text'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void Writeln([MarshalAs(UnmanagedType.LPStruct)] nsAString text);
		
		/// <summary>Member GetElementsByName </summary>
