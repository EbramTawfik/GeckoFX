...
// 
// File: nsIDOMHTMLFrameElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLFrameElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("a6cf90b9-15b3-11d2-932e-00805f8add32")]
	public interface nsIDOMHTMLFrameElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetFrameBorderAttribute </summary>
		/// <param name='aFrameBorder'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetFrameBorderAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aFrameBorder);
		
		/// <summary>Member SetFrameBorderAttribute </summary>
		/// <param name='aFrameBorder'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFrameBorderAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aFrameBorder);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetMarginHeightAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aMarginHeight);
		
		/// <summary>Member SetMarginHeightAttribute </summary>
		/// <param name='aMarginHeight'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMarginHeightAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aMarginHeight);
		
		/// <summary>Member GetMarginWidthAttribute </summary>
		/// <param name='aMarginWidth'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetMarginWidthAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aMarginWidth);
		
		/// <summary>Member SetMarginWidthAttribute </summary>
		/// <param name='aMarginWidth'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMarginWidthAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aMarginWidth);
		...
		/// <summary>Member GetNoResizeAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetNoResizeAttribute();
		
		/// <summary>Member SetNoResizeAttribute </summary>
		/// <param name='aNoResize'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetNoResizeAttribute(System.Boolean  aNoResize);
		
		/// <summary>Member GetScrollingAttribute </summary>
		/// <param name='aScrolling'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetScrollingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aScrolling);
		
		/// <summary>Member SetScrollingAttribute </summary>
		/// <param name='aScrolling'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetScrollingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aScrolling);
