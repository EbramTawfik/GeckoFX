...
namespace Gecko
{
	...
	[Guid("07fb24d2-a102-41a2-bdaa-eb5e0d399eba")]
	public interface nsIDOMCloseEvent : nsIDOMEvent
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitCloseEvent([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aType, [MarshalAs(UnmanagedType.U1)] bool aCanBubble, [MarshalAs(UnmanagedType.U1)] bool aCancelable, [MarshalAs(UnmanagedType.U1)] bool aWasClean, ushort aReasonCode, [MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aReason);
	}
	
	/// <summary>nsICloseEventInit </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("148ed08e-14f1-4be5-b2f8-23f765738379")]
	public interface nsICloseEventInit : nsIEventInit
	{
		...
		/// <summary>Member SetWasCleanAttribute </summary>
		/// <param name='aWasClean'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetWasCleanAttribute([MarshalAs(UnmanagedType.U1)] bool aWasClean);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCodeAttribute(ushort aCode);
		...
		/// <summary>Member SetReasonAttribute </summary>
		/// <param name='aReason'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetReasonAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aReason);
	}
}
