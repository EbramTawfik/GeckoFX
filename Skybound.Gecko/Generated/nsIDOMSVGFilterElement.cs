...
// 
// File: nsIDOMSVGFilterElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMSVGFilterElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("9e81d4ae-190c-4b9d-a076-ebc52a7bf231")]
	public interface nsIDOMSVGFilterElement : nsIDOMSVGElement
	{
		...
		/// <summary>Member GetFilterResXAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedInteger </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedInteger  GetFilterResXAttribute();
		
		/// <summary>Member GetFilterResYAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedInteger </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedInteger  GetFilterResYAttribute();
		
		/// <summary>Member SetFilterRes </summary>
		/// <param name='filterResX'> </param>
		/// <param name='filterResY'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFilterRes(System.UInt32  filterResX, System.UInt32  filterResY);
	}
}
