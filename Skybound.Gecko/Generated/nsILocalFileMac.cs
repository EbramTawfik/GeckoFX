...
namespace Skybound.Gecko
{
	...
	public interface nsILocalFileMac : nsILocalFile
	{
		...
		/// <summary>Member InitWithCFURL </summary>
		/// <param name='aCFURL'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitWithCFURL(System.IntPtr aCFURL);
		
		/// <summary>Member InitWithFSRef </summary>
		/// <param name='aFSRef'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitWithFSRef(System.IntPtr aFSRef);
		
		/// <summary>Member GetCFURL </summary>
		/// <returns>A System.IntPtr</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.IntPtr GetCFURL();
		
		/// <summary>Member GetFSRef </summary>
		/// <returns>A System.IntPtr</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.IntPtr GetFSRef();
		
		/// <summary>Member GetFSSpec </summary>
		/// <returns>A System.IntPtr</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.IntPtr GetFSSpec();
		
		/// <summary>Member GetFileSizeWithResForkAttribute </summary>
		/// <returns>A System.Int64 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Int64  GetFileSizeWithResForkAttribute();
		
		/// <summary>Member GetFileTypeAttribute </summary>
		/// <returns>A System.IntPtr </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.IntPtr  GetFileTypeAttribute();
		
		/// <summary>Member SetFileTypeAttribute </summary>
		/// <param name='aFileType'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFileTypeAttribute(System.IntPtr  aFileType);
		
		/// <summary>Member GetFileCreatorAttribute </summary>
		/// <returns>A System.IntPtr </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.IntPtr  GetFileCreatorAttribute();
		
		/// <summary>Member SetFileCreatorAttribute </summary>
		/// <param name='aFileCreator'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFileCreatorAttribute(System.IntPtr  aFileCreator);
		
		/// <summary>Member LaunchWithDoc </summary>
		/// <param name='aDocToLoad'> </param>
		/// <param name='aLaunchInBackground'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void LaunchWithDoc([MarshalAs(UnmanagedType.Interface)] nsILocalFile  aDocToLoad, System.Boolean  aLaunchInBackground);
		
		/// <summary>Member OpenDocWithApp </summary>
		/// <param name='aAppToOpenWith'> </param>
		/// <param name='aLaunchInBackground'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void OpenDocWithApp([MarshalAs(UnmanagedType.Interface)] nsILocalFile  aAppToOpenWith, System.Boolean  aLaunchInBackground);
		
		/// <summary>Member IsPackage </summary>
		/// <returns>A System.Boolean</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		bool IsPackage();
		
		/// <summary>Member GetBundleDisplayNameAttribute </summary>
		/// <param name='aBundleDisplayName'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetBundleDisplayNameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aBundleDisplayName);
