...
namespace Gecko
{
	...
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("610eb27e-9718-4acd-8ed1-7d1840bc6c7f")]
	public interface nsIUIEventInit : nsIEventInit
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetViewAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMWindow aView);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetDetailAttribute(int aDetail);
	}
}
