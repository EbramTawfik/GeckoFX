...
// 
// File: nsIDOMHTMLFrameSetElement.cs
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLFrameSetElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("a6cf90b8-15b3-11d2-932e-00805f8add32")]
	public interface nsIDOMHTMLFrameSetElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetColsAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aCols);
		
		/// <summary>Member SetColsAttribute </summary>
		/// <param name='aCols'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetColsAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aCols);
		
		/// <summary>Member GetRowsAttribute </summary>
		/// <param name='aRows'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetRowsAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aRows);
