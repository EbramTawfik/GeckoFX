...
namespace Skybound.Gecko
{
	...
	/// <summary>nsITestXPCFunctionCallback </summary>
	[ComImport()]
	...
	public interface nsITestXPCFunctionCallback
	{
		...
		/// <summary>Member CallWithThis </summary>
	...
	public interface nsIEcho
	{
		...
		/// <summary>Member PrintArgTypes </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void PrintArgTypes();
		
		/// <summary>Member ThrowArg </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void ThrowArg();
	...
	/// <summary>nsIXPCTestParent </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public interface nsIXPCTestParent
	{
		...
		/// <summary>Member Method1 </summary>
		/// <param name='i'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
	...
	public interface nsITestVariant
	{
		...
		/// <summary>Member CopyVariantAsTypeTwice </summary>
		/// <param name='value'> </param>
		...
		/// <summary>Member GetNamedProperty </summary>
		/// <param name='aBag'> </param>
