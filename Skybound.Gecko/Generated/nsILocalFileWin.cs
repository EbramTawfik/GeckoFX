...
namespace Skybound.Gecko
{
	...
	public interface nsILocalFileWin : nsILocalFile
	{
		...
		/// <summary>Member GetVersionInfoField </summary>
		/// <param name='aField'> </param>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsAString GetVersionInfoField([MarshalAs(UnmanagedType.LPStr)] System.String  aField);
		
		/// <summary>Member GetCanonicalPathAttribute </summary>
		/// <param name='aCanonicalPath'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetCanonicalPathAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aCanonicalPath);
		
		/// <summary>Member GetNativeCanonicalPathAttribute </summary>
		/// <param name='aNativeCanonicalPath'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetNativeCanonicalPathAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aNativeCanonicalPath);
		
		/// <summary>Member GetFileAttributesWinAttribute </summary>
		/// <returns>A System.UInt32 </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.UInt32  GetFileAttributesWinAttribute();
		
		/// <summary>Member SetFileAttributesWinAttribute </summary>
		/// <param name='aFileAttributesWin'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFileAttributesWinAttribute(System.UInt32  aFileAttributesWin);
	}
}
