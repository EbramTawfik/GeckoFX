...
// 
// File: nsIDOMHTMLIsIndexElement.cs
// Responsibility: Generated by IDLImporter
// Last reviewed: 
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMHTMLIsIndexElement.idl
// 
...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLIsIndexElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("a6cf908c-15b3-11d2-932e-00805f8add32")]
	public interface nsIDOMHTMLIsIndexElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetPromptAttribute </summary>
		/// <param name='aPrompt'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetPromptAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aPrompt);
		
		/// <summary>Member SetPromptAttribute </summary>
		/// <param name='aPrompt'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetPromptAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aPrompt);
	}
}
