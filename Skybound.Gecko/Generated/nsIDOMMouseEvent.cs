...
namespace Gecko
{
	...
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("9495a977-5c9e-4b34-8d51-22bfd9b4fcf6")]
	public interface nsIMouseEventInit : nsIUIEventInit
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetViewAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMWindow aView);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetDetailAttribute(int aDetail);
		...
		/// <summary>Member SetClientXAttribute </summary>
		/// <param name='aClientX'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetClientXAttribute(int aClientX);
		...
		/// <summary>Member SetClientYAttribute </summary>
		/// <param name='aClientY'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetClientYAttribute(int aClientY);
		...
		/// <summary>Member SetCtrlKeyAttribute </summary>
		/// <param name='aCtrlKey'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCtrlKeyAttribute([MarshalAs(UnmanagedType.U1)] bool aCtrlKey);
		...
		/// <summary>Member SetShiftKeyAttribute </summary>
		/// <param name='aShiftKey'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetShiftKeyAttribute([MarshalAs(UnmanagedType.U1)] bool aShiftKey);
		...
		/// <summary>Member SetAltKeyAttribute </summary>
		/// <param name='aAltKey'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetAltKeyAttribute([MarshalAs(UnmanagedType.U1)] bool aAltKey);
		...
		/// <summary>Member SetMetaKeyAttribute </summary>
		/// <param name='aMetaKey'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMetaKeyAttribute([MarshalAs(UnmanagedType.U1)] bool aMetaKey);
		...
		/// <summary>Member SetButtonAttribute </summary>
		/// <param name='aButton'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetButtonAttribute(ushort aButton);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetRelatedTargetAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMEventTarget aRelatedTarget);
	}
}
