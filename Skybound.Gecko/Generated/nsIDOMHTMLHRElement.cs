...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMHTMLHRElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("a6cf90a8-15b3-11d2-932e-00805f8add32")]
	public interface nsIDOMHTMLHRElement : nsIDOMHTMLElement
	{
		...
		/// <summary>Member GetNoShadeAttribute </summary>
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetNoShadeAttribute();
		
		/// <summary>Member SetNoShadeAttribute </summary>
		/// <param name='aNoShade'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetNoShadeAttribute(System.Boolean  aNoShade);
