...
namespace Gecko
{
	...
	public interface nsIUTF8ConverterService
	{
		...
		void ConvertStringToUTF8([MarshalAs(UnmanagedType.LPStruct)] nsACStringBase aString, [MarshalAs(UnmanagedType.LPStr)] string aCharset, [MarshalAs(UnmanagedType.Bool)] bool aSkipCheck, [MarshalAs(UnmanagedType.LPStruct)] nsAUTF8String retval);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void ConvertURISpecToUTF8([MarshalAs(UnmanagedType.LPStruct)] nsACStringBase aSpec, [MarshalAs(UnmanagedType.LPStr)] string aCharset, [MarshalAs(UnmanagedType.LPStruct)] nsAUTF8String retval);
	}
}
