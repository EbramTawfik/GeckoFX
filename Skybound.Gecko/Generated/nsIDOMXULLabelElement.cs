...
namespace Skybound.Gecko
{
	...
	[Guid("0f36a6e1-714e-49fa-80d2-9777a6e8682b")]
	public interface nsIDOMXULLabelElement : nsIDOMXULDescriptionElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetCropAttribute([MarshalAs(UnmanagedType.Bool)] bool aCrop);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetControlAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aControl);
		
		/// <summary>Member SetControlAttribute </summary>
		/// <param name='aControl'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetControlAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aControl);
	}
}
