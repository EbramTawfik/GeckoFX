...
namespace Skybound.Gecko
{
	...
	public interface nsIDOMBlob
	{
		...
		/// <summary>Member GetInternalUrl </summary>
	...
	public interface nsIDOMFile : nsIDOMBlob
	{
		...
		/// <summary>Member GetMozFullPathInternalAttribute </summary>
		/// <param name='aMozFullPathInternal'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		/// <summary>Member GetAsDataURL </summary>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsAString GetAsDataURL();
		
		/// <summary>Member GetAsBinary </summary>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
