...
namespace Gecko
{
	...
	public interface nsIDOMMozCSSKeyframeRule : nsIDOMCSSRule
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetKeyTextAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aKeyText);
		
		/// <summary>Member SetKeyTextAttribute </summary>
		/// <param name='aKeyText'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetKeyTextAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString aKeyText);
