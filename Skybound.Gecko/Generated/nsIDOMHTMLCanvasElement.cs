...
// 
// File: nsIDOMHTMLCanvasElement.cs
...
namespace Skybound.Gecko
{
	...
	[Guid("53ad994a-3cd0-48fa-8ffb-7f3d8cd19c50")]
	public interface nsIDOMHTMLCanvasElement : nsIDOMHTMLElement
	{
		...
		/// <returns>A System.Boolean </returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		System.Boolean  GetMozOpaqueAttribute();
		
		/// <summary>Member SetMozOpaqueAttribute </summary>
		/// <param name='aMozOpaque'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMozOpaqueAttribute(System.Boolean  aMozOpaque);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsISupports GetContext([MarshalAs(UnmanagedType.LPStruct)] nsAString contextId, System.IntPtr contextOptions);
		
		/// <summary>Member ToDataURL </summary>
		/// <param name='type'> </param>
		/// <param name='params'> </param>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsAString ToDataURL([MarshalAs(UnmanagedType.LPStruct)] nsAString type, [MarshalAs(UnmanagedType.LPStruct)] nsAString @params);
		
		/// <summary>Member ToDataURLAs </summary>
		/// <param name='mimeType'> </param>
		/// <param name='encoderOptions'> </param>
		/// <returns>A nsAString</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsAString ToDataURLAs([MarshalAs(UnmanagedType.LPStruct)] nsAString mimeType, [MarshalAs(UnmanagedType.LPStruct)] nsAString encoderOptions);
		
		/// <summary>Member MozGetAsFile </summary>
		/// <param name='name'> </param>
		/// <param name='type'> </param>
		/// <returns>A nsIDOMFile</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMFile MozGetAsFile([MarshalAs(UnmanagedType.LPStruct)] nsAString name, [MarshalAs(UnmanagedType.LPStruct)] nsAString type);
		
		/// <summary>Member MozGetIPCContext </summary>
		/// <param name='contextId'> </param>
		/// <returns>A nsISupports</returns>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsISupports MozGetIPCContext([MarshalAs(UnmanagedType.LPStruct)] nsAString contextId);
	}
}
