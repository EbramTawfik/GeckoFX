...
namespace Skybound.Gecko
{
	...
	public interface nsIDOMXULMultiSelectControlElement : nsIDOMXULSelectControlElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new nsIDOMXULSelectControlItemElement InsertItemAt(int index, [MarshalAs(UnmanagedType.LPStruct)] nsAString label, [MarshalAs(UnmanagedType.LPStruct)] nsAString value);
