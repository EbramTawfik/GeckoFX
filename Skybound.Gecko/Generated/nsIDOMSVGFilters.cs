...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIDOMSVGFEImageElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	/// <summary>nsIDOMSVGFEDisplacementMapElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	public interface nsIDOMSVGFEDisplacementMapElement : nsIDOMSVGFilterPrimitiveStandardAttributes
	{
		...
		/// <summary>Member GetXChannelSelectorAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedEnumeration </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedEnumeration  GetXChannelSelectorAttribute();
		
		/// <summary>Member GetYChannelSelectorAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedEnumeration </returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
