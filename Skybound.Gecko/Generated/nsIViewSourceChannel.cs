...
namespace Skybound.Gecko
{
	...
	/// <summary>nsIViewSourceChannel </summary>
	[ComImport()]
	...
	public interface nsIViewSourceChannel : nsIChannel
	{
		...
		/// <summary>Member GetOriginalContentTypeAttribute </summary>
		/// <param name='aOriginalContentType'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetOriginalContentTypeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAString  aOriginalContentType);
		
		/// <summary>Member SetOriginalContentTypeAttribute </summary>
		/// <param name='aOriginalContentType'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
