...
namespace Gecko.Utils
{
    ...
    {
        internal static GeckoCanvasElement CreateCanvasOfImageElement(GeckoWebBrowser browser, GeckoElement element, float xOffset,
        ...
        /// </summary>
        public static byte[] ConvertGeckoImageElementToPng(GeckoWebBrowser browser, GeckoElement element, float xOffset,
                                                           float yOffset, float width, float height)
        {
        ...
        /// </summary>
        public bool CopyGeckoImageElementToPng(GeckoWebBrowser browser, GeckoElement element, float xOffset,
                                                      float yOffset, float width, float height)
        {
            GeckoCanvasElement canvas = CreateCanvasOfImageElement(browser, element, xOffset, yOffset, width, height);
